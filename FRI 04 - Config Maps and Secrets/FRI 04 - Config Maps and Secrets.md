...
Just like the last lab, we will work inside a dedicated, clean namespace to keep things organized.
...
💡 **What is happening here?** We are creating a sandbox namespace called `lab` and setting our default context to it. Every command you run from this point forward will automatically apply to the `lab` namespace.
